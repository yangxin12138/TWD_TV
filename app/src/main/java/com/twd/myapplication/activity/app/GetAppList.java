package com.twd.myapplication.activity.app;
...
import com.twd.myapplication.bean.AppBean;
...
public class GetAppList {
    ...
    public ArrayList<AppBean> getLauncherAppList() {
        ...
        while (true) {
            ...
            //屏蔽自己、芒果、tcl版
            if (!noSeeApk.equals("com.twd") && !noSeeApk.endsWith("com.starcor.hunan") && !noSeeApk.endsWith("com.tcl.matrix.tventrance")) {
