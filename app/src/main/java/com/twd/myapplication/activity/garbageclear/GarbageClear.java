package com.twd.myapplication.activity.garbageclear;
...
import com.twd.myapplication.activity.garbageclear.util.ClearUtil;
...
public class GarbageClear extends Activity {
    ...
    public void Linstener() {
        StartClear.setOnClickListener(new View.OnClickListener() {
        ...
        StartFound.setOnClickListener(new View.OnClickListener() {
