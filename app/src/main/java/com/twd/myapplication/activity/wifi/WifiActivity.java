...
import com.twd.myapplication.activity.wifi.util.WiFiAdmin;
...
public class WifiActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        // TODO Auto-generated method stub
        if(GetNowWifiSSID().equals("\""+scanResults.get(position).SSID+"\"")){
            ...
            WifiName.setText(scanResults.get(position).SSID);
            ConnectDialog.show();
