...
import com.twd.myapplication.application.ClientApplication;
...
public class FileUtils {
    private final static String TAG = "FileUtil------读取文件工具类";
    private final static boolean d = ClientApplication.debug;
    ...
    public static String getFileNameFormat(String filePath) {
    ...
    public static String saveLog(String msgID,String log,boolean isLog,String fileName) {
        ...
        SimpleDateFormat logTime = new SimpleDateFormat("yyyyMMddHH");
